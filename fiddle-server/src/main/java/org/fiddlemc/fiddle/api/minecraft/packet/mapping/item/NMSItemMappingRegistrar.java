...
import org.fiddlemc.fiddle.impl.minecraft.packet.mapping.item.ItemMapping;

import java.util.List;
import java.util.function.Consumer;

/**
 * Provides functionality to register {@link ItemMapping}s using Minecraft internals.
 */
public interface NMSItemMappingRegistrar extends ItemMappingRegistrar {
