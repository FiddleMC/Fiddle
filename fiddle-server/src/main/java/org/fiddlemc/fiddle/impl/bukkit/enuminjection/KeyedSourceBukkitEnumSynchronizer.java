 ...
 */
public abstract class KeyedSourceBukkitEnumSynchronizer<E extends Enum<E>, S, I extends EnumInjector<E>, P extends BukkitEnumNameMappingPipelineImpl<S> & SingleStepMappingPipeline<String, BukkitEnumNamePickFunctionHandle<S>, BukkitEnumNamesComposeEvent<S>>> extends BukkitEnumSynchronizer<E, S, I, P> {
