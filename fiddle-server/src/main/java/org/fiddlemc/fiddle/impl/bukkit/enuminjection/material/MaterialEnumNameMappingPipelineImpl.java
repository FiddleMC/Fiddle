...
/**
 * The implementation of {@link MaterialEnumNameMappingPipeline}.
 */
public final class MaterialEnumNameMappingPipelineImpl extends BukkitEnumNameMappingPipelineImpl<Triple<NamespacedKey, @Nullable BlockType, @Nullable ItemType>> implements MaterialEnumNameMappingPipeline {

    public static final class ServiceProviderImpl extends NoArgsConstructorServiceProviderImpl<MaterialEnumNameMappingPipeline, MaterialEnumNameMappingPipelineImpl> implements ServiceProvider {
    ...
    public static MaterialEnumNameMappingPipelineImpl get() {
        return (MaterialEnumNameMappingPipelineImpl) MaterialEnumNameMappingPipeline.get();
    }
