package org.fiddlemc.fiddle.paper.registry;
...
import org.fiddlemc.fiddle.paper.registry.data.KeyAwareRegistryEntry;
 ...
 */
public class KeyAwareWritableCraftRegistry<M, T extends Keyed, B extends KeyAwareRegistryEntry & PaperRegistryBuilder<M, T>> extends WritableCraftRegistry<M, T, B> {
     ...
     * that calls {@link KeyAwareRegistryEntry#setKey}.
     */
